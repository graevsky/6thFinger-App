...
import com.example.a6thfingercontrolapp.ble.EMG_ACTION_BEND
import com.example.a6thfingercontrolapp.ble.EMG_ACTION_COOLDOWN_IGNORED
import com.example.a6thfingercontrolapp.ble.EMG_ACTION_NONE
import com.example.a6thfingercontrolapp.ble.EMG_ACTION_UNFOLD
import com.example.a6thfingercontrolapp.ble.EMG_EVENT_BEND
import com.example.a6thfingercontrolapp.ble.EMG_EVENT_NONE
import com.example.a6thfingercontrolapp.ble.EMG_EVENT_OTHER
import com.example.a6thfingercontrolapp.ble.EMG_EVENT_UNFOLD
import com.example.a6thfingercontrolapp.ble.EMG_MODE_BEND_OTHER
import com.example.a6thfingercontrolapp.ble.EMG_MODE_DIRECTIONAL
